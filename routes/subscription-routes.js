...
// Delete the notification message with given id.
router.delete('/notifications/:id', verifyAuthenticated, async function (req, res) {
    const notificationId = req.params.id;
    await subscriptionDao.deleteNotification(notificationId);
    res.status(204).end();
});
